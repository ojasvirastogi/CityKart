...
// ✅ Array of images and text for slider
const ImageList = [
  {
    id: 1,
    img: Image1,
  ...
  },
  {
    ...
    description: "Who's there lorem ipsum...",
  },
  {
    id: 3,
    img: Image3,
...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    ...
    >
      <div
        className="
          h-[700px] w-[700px] bg-primary/40 absolute 
          -top-1/2 right-0 rounded-3xl rotate-45 
          -z[8] dark:bg-primary/20
        "
      ></div>
          ...
          {ImageList.map((data) => (
            <div key={data.id}>
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="
                  flex flex-col justify-center gap-4 pt-12 sm:pt-0 
